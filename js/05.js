...
const invokeAdd = invokeInventoryAction(
  'Medkit',
  inventory.add.bind(inventory), // Write code in this line ===было дописано .bind(inventory)===
);
...
const invokeRemove = invokeInventoryAction(
  'Gas mask',
  inventory.remove.bind(inventory), // Write code in this line ===было дописано .bind(inventory)===
);
